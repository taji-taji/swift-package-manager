...
public class Workspace {
    ...
    public static func _init(
        ...
        location: Location,
        authorizationProvider: AuthorizationProvider? = .none,
        registryClient: RegistryClientInterface? = .none,
        registryDownloadsManager: RegistryDownloadsManagerInterface? = .none,
        configuration: WorkspaceConfiguration? = .none,
        cancellator: Cancellator? = .none,
        initializationWarningHandler: ((String) -> Void)? = .none,
    ...
    private init(
        ...
        registryDownloadsManager: RegistryDownloadsManagerInterface?,
        ...
        if let registryClient = registryClient, registryClient.configured, let transformationMode = RegistryAwareManifestLoader.TransformationMode(configuration.sourceControlToRegistryDependencyTransformation) {
...
extension Workspace: PackageContainerProvider {
    public func getContainer(
        ...
        do {
            ...
            case .registry:
                guard let registryClient = registryClient else {
                    return completion(.failure(StringError("no registry client available")))
                }
